...
1. First let's calculate and report the total number of missing values in the dataset. From the output, We can see that there is no missing values for the variables `date` and `interval`, and we have `r numna` missing values for the variable `steps`.
